export const menuItemsQL = [
    { name: "Trang chủ", link: "/" },
    { name: "Sản phẩm", link: "/san-pham" },
    { name: "Nguyên liệu", link: "/nguyen-lieu" },
    { name: "Nhập hàng", link: "/nhap-hang" },
    { name: "Thông tin", link: "/thong-tin" },
    { name: "Thống kê", link: "/thong-ke" }
  ];
  ...
  export const QLNHItems = [
    { id: 1, name: 'Danh sách đơn đặt mua', link: '/don-dat-mua' },
    { id: 2, name: 'Danh sách phiếu nhập', link: '/phieu-nhap' },
    { id: 3, name: 'Danh sách nhà cung cấp', link: '/nha-cung-cap' }
    // Add more items as needed
  ];
  ...
  export const QLTTItems = [
    { id: 1, name: 'Thông tin nhân viên', link: 'thong-tin-nhan-vien' },
    { id: 2, name: 'Thông tin khách hàng', link: 'thong-tin-khach-hang' },
    // Add more items as needed
  ];
